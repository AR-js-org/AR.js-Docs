...
- [Develop a Simple Points of Interest App (LocAR.js version)](https://github.com/AR-js-org/locar.js/blob/master/docs/tutorial/index.md) : develop a points of interest app with the new LocAR.js API.
